...
const outDir = path.join(__dirname, "..", "tractor-tracker", "public");
...
function buildSupervisorManual() {
  ...
  sections.push(...[
    ...
    spacer(80),
    coverSub("Complete guide to managing JCB workers,", WHITE),
  ...
  sections.push(
    ...
    step(2, "Enter your Mobile Number", 'Type your 10-digit mobile number in the "JCB Number / Mobile" field.'),
  ...
  sections.push(
    ...
    body("The Dashboard is your main overview. It shows a summary of all workers under your client — their earnings, payments made, and pending balances."),
    heading3("Summary Cards"),
    body("At the top of the Dashboard you will see four summary cards:"),
    spacer(80),
    infoBox([
      ["👷  Workers", "Total active workers", BLUE],
    ...
    heading3("Pending Workers List"),
    body("Below the progress bar you will see a card for each worker with a pending balance. Each card shows:"),
    bullet("", "Worker's name and initials circle"),
  ...
  sections.push(
    pageBreak(),
    sectionLabel("3"),
    heading1("Filtering by JCB Machine"),
    body("As a Supervisor, you oversee multiple JCB machines. Use the JCB filter to view data for one specific JCB at a time."),
    heading3("Where to Find the Filter"),
    body("Just below the Dashboard title, you will see a blue filter bar with a dropdown showing the current JCB selection."),
    spacer(80),
    infoBox([
      ["Default view", "All JCBs (combined data)", BLUE],
      ["Filtered view", "JCB-001 only, or JCB-002, etc.", GREEN],
    ]),
    spacer(120),
    heading3("How to Use the Filter"),
    step(1, "Tap the filter dropdown", 'Shows "All JCBs" by default — combined data from all machines.'),
    step(2, "Select a JCB machine", "Choose JCB-001, JCB-002, etc. The worker list and summary update instantly."),
    step(3, "Return to combined view", 'Select "All JCBs" to see data from all machines together.'),
    spacer(120),
    tip("The same JCB filter is available on the Expenses page and the History page. Each page has its own independent filter."),
    spacer(120),
  );
  ...
  sections.push(
    pageBreak(),
    sectionLabel("4"),
    heading1("Worker Payment Cards"),
    body("Each worker with a pending balance appears as a card on the Dashboard. Fully paid workers are hidden here — you can view them on the History page."),
    heading3("Reading a Worker Card"),
    spacer(80),
    infoBox([
      ["Name / Initials circle", "Identifies the worker", BLUE],
      ["Pending badge (orange)", "Amount still owed", AMBER],
      ["Earned", "All-time total earned", "059669"],
      ["Paid", "All-time total paid", BLUE],
    ]),
    spacer(120),
    heading3("Viewing Worker Detail"),
    body("Tap the worker card (or the arrow icon) to open the full detail page showing all individual work sessions and every payment made."),
    spacer(120),
  );
  ...
  sections.push(
    ...
    body("When you pay a worker, record it in Smart Lekka so the pending balance stays accurate."),
    heading3("Steps to Record a Payment"),
    step(1, "Find the worker on the Dashboard", "Scroll the pending workers list."),
    ...
    step(4, 'Tap "Record Payment"', "The balance updates immediately. If fully paid, the worker moves off the home screen."),
    spacer(120),
  ...
  sections.push(
    ...
    body("The History page shows all workers — pending and fully paid — along with every work session and payment in detail."),
    heading3("Available Filters"),
    bullet("JCB Filter", "", "Show sessions from a specific JCB machine only (blue filter bar)."),
    bullet("Worker Filter", "", "Choose a specific worker from the dropdown."),
    bullet("Status — Pending", "", "Show only workers with remaining balances."),
    bullet("Status — Settled", "", "Show only workers who are fully paid up."),
    spacer(120),
    ...
    body("Each payment shows: date and amount paid. Running totals (earned / paid / pending) are shown at the top of each worker section."),
    spacer(120),
  );
  ...
  sections.push(
    ...
    body("Track all JCB-related expenses — fuel, maintenance, salaries, materials, and other costs."),
    heading3("JCB Filter on Expenses"),
    body("As a Supervisor, you see expenses from all JCB machines by default. Use the blue JCB filter bar to narrow to a specific machine."),
  ...
  sections.push(
    ...
    body("Generate a professional PDF report for any time period, for all or selected workers, with an optional JCB filter."),
    heading3("Steps to Download a Report"),
    step(1, "Go to the Dashboard", 'Set the JCB filter first if you want a per-machine report.'),
    step(2, 'Tap "Download Report"', "Appears in the top-right of the Dashboard."),
    step(3, "Choose Workers", 'Select "All Workers" or a specific worker.'),
    step(4, "Choose a Date Period", "Options: All Time, This Month, Last Month, or Custom."),
    step(5, 'Review "Report will include" summary', "If a JCB filter is active, the JCB name is shown in blue."),
    step(6, 'Tap "Generate PDF"', "The PDF downloads to your device automatically."),
    spacer(120),
    tip("The PDF includes: a summary table per worker, all individual work sessions with dates and hours, and all payment records."),
    spacer(120),
  );
  ...
  sections.push(
    ...
    spacer(80),
    infoBox([
      ["🏠  Home (Dashboard)", "Summary + pending workers + JCB filter", BLUE],
      ["⏱  Track", "Start live timer or add manual work entry", BLUE],
      ["📋  History", "Full session and payment history", BLUE],
      ["💰  Expenses", "All expenses with JCB filter and date range", BLUE],
    ]),
    spacer(120),
...
function buildJcbManual() {
  ...
  sections.push(...[
    ...
    new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 80 }, children: [new TextRun({ text: "JCB Operator Role — User Manual", size: 26, color: "A7F3D0" })] }),
    spacer(80),
  ...
  sections.push(
    ...
    body("Use your JCB machine number and password to sign in. Your credentials are provided by your admin or supervisor."),
    heading3("Steps to Log In"),
    stepGreen(1, "Open Smart Lekka in your phone browser", "The login screen appears."),
    stepGreen(2, "Enter your JCB Number", "Type your machine number (e.g. JCB001, JCB002) in the JCB Number / Mobile field."),
    stepGreen(3, "Enter your Password", "Given to you by the admin."),
    stepGreen(4, "Tap Sign In", "You land on your personal Dashboard."),
    spacer(120),
    tipGreen("Your JCB Number is your login ID. It is usually in the format JCB001, JCB002, etc. Contact your admin if you need your credentials."),
    spacer(120),
  );
  ...
  sections.push(
    ...
    body("Your Dashboard shows a summary of workers and their payment status — all work logged by your JCB machine. No JCB filter is needed; it is automatically set to your machine."),
    heading3("Summary Cards"),
    spacer(80),
    infoBox([
      ["👷  Workers", "Workers who worked on your JCB sessions", GREEN],
  ...
  sections.push(
    ...
    stepGreen(2, "Select or add a Worker", 'Choose from the dropdown, or tick "Add new worker on the fly".'),
  ...
  sections.push(
    ...
    stepGreen(2, "Select the Worker", "Choose from the dropdown or add a new worker."),
  ...
  sections.push(
    ...
    body("The History page shows all sessions logged under your JCB and all payments made to workers."),
    heading3("Filters"),
    bullet("Worker Filter", "", "Choose a specific worker from the dropdown."),
    bullet("Status: Pending", "", "Workers who still have unpaid balances."),
    bullet("Status: Settled", "", "Workers who have been fully paid."),
    bullet("Status: All", "", "All workers regardless of payment status."),
    spacer(120),
    heading3("Reading Session Entries"),
    body("Each session shows: Field Name, Date, Start → End time, Hours worked, and Amount earned (Hours × Rate)."),
    heading3("Reading Payment Entries"),
    body("Each payment entry shows the date and amount paid. Payments are grouped under the worker they belong to."),
    spacer(120),
  );
  ...
  sections.push(
    ...
    body("Log any JCB-related cost — fuel, repairs, or materials. These are tracked separately from worker wages."),
  ...
  sections.push(
    ...
    body("Get a PDF of your work sessions and worker payments from the Dashboard."),
    heading3("Steps"),
    stepGreen(1, "Go to the Dashboard (Home)", "Your data is shown automatically."),
    stepGreen(2, 'Tap "Download Report"', "Top-right button (appears when you have worker data)."),
    stepGreen(3, "Choose Workers and Date Range", "Select all or a specific worker. Choose the time period."),
    stepGreen(4, 'Tap "Generate PDF"', "Downloads to your device. Your JCB name is shown in the PDF header automatically."),
    spacer(120),
    tipGreen("Your JCB name/number is included in the downloaded PDF header automatically since you are logged in as a JCB operator."),
    spacer(120),
  );
  ...
  sections.push(
    ...
    spacer(80),
    infoBox([
      ["🏠  Home", "Dashboard — summary totals + pending workers", GREEN],
      ["⏱  Track", "Start live timer OR add a past work entry manually", GREEN],
      ["📋  History", "All sessions and payment records per worker", GREEN],
      ["💰  Expenses", "Log and track all JCB expenses", GREEN],
    ]),
    spacer(120),
      ...
      headers: {
        default: new Header({
          children: [new Paragraph({
            alignment: AlignmentType.RIGHT,
            border: { bottom: { style: BorderStyle.SINGLE, size: 6, color: "CBD5E1" } },
            children: [new TextRun({ text: "Smart Lekka  ·  JCB Operator Manual", size: 18, color: "94A3B8" })],
          })],
        }),
      },
      footers: {
...
function buildCombinedManual() {
  ...
  sections.push(...[
    ...
    spacer(80),
    new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 60 }, children: [new TextRun({ text: "🏗️  Supervisor  ·  🚜  JCB Operator", size: 26, color: WHITE })] }),
    spacer(80),
  ...
  sections.push(
    ...
    step(2, "Enter your Mobile Number", "Your 10-digit mobile in the JCB Number / Mobile field."),
    ...
    body("The Dashboard shows a full summary across all JCBs — or for one specific JCB when filtered."),
    spacer(80),
    infoBox([
      ["👷  Workers", "Active workers in your client", BLUE],
      ["📈  Total Earned", "All sessions combined", "059669"],
      ["💼  Total Paid", "Already paid out", BLUE],
      ["⏳  Pending", "Amount still owed", AMBER],
    ]),
    spacer(100),
    body("The Payment Progress Bar below the cards shows percentage paid. Pending workers appear below as cards with a Pay button."),
    spacer(100),

    pageBreak(),
    sectionLabel("A3"),
    heading1("JCB Machine Filter (Supervisor)"),
    body("The blue JCB filter bar lets you focus on one machine. It appears on Dashboard, History, and Expenses."),
    bullet("All JCBs", "", "Default — shows combined data from all machines."),
    bullet("JCB-001, JCB-002…", "", "Filters to that machine's workers and sessions only."),
    spacer(100),
    tip("The JCB filter is independent on each page — changing it on Dashboard does not affect Expenses or History."),
    spacer(100),
    ...
    step(1, "Find the worker card on the Dashboard", "Scroll the pending workers list."),
    ...
    body("Shows ALL workers (pending and settled) with every session and payment. Filter by JCB, Worker, or Status."),
    bullet("JCB Filter", "", "Blue filter bar — one machine or all."),
    bullet("Worker Filter", "", "Focus on one worker's full history."),
    ...
    body("View expenses for all JCBs or filter by machine. Date range filter is also available."),
    spacer(80),
    infoBox([
    ...
    body("Generate a report for any period with optional JCB filter."),
    step(1, "Set JCB filter on Dashboard", "All JCBs or a specific machine."),
    step(2, 'Tap "Download Report"', "Top-right of Dashboard."),
    step(3, "Choose Workers and Period", "All Time / This Month / Last Month / Custom."),
    step(4, 'Tap "Generate PDF"', "Downloads automatically. JCB name shown in PDF header if filtered."),
    spacer(100),
  );
  ...
  sections.push(
    ...
    new Paragraph({
      ...
      children: [
        new TextRun({ text: "  ──────  PART B — JCB OPERATOR ROLE  ──────  ", bold: true, size: 32, color: WHITE }),
      ],
    }),
    sectionLabel("B1", GREEN),
    heading1("Logging In (JCB Operator)", DGREEN),
    body("Use your JCB machine number as your login ID and the password given by your admin."),
    stepGreen(1, "Open Smart Lekka in your phone browser", ""),
    stepGreen(2, "Enter your JCB Number", "e.g. JCB001, JCB002."),
    ...
    heading1("Dashboard Overview (JCB Operator)", DGREEN),
    body("Shows data only for workers with sessions logged under your JCB. No JCB filter is shown — it is automatically set to your machine."),
    spacer(80),
    infoBox([
      ["👷  Workers", "Workers on your sessions", GREEN],
    ...
    stepGreen(2, "Select or add a Worker", 'Choose from dropdown or tick "Add new worker on the fly".'),
    ...
    heading1("Viewing Work History (JCB Operator)", DGREEN),
    body("History shows all sessions under your JCB and all worker payments."),
    bullet("Worker Filter", "", "Focus on one worker."),
    bullet("Pending / Settled", "", "Filter by payment status."),
    spacer(100),

    pageBreak(),
    sectionLabel("B6", GREEN),
    heading1("Adding Expenses (JCB Operator)", DGREEN),
    body("Log any JCB cost — fuel, repairs, materials, etc."),
    ...
    heading1("Downloading Your PDF Report (JCB Operator)", DGREEN),
    ...
    stepGreen(3, "Choose Workers and Period", ""),
    stepGreen(4, 'Tap "Generate PDF"', "Your JCB name is automatically shown in the PDF header."),
    spacer(100),
  );
        ...
        new TableRow({
          ...
          children: [
            ...
            new TableCell({
              ...
              children: [new Paragraph({ children: [new TextRun({ text: "🚜  JCB Operator", bold: true, size: 20, color: WHITE })] })],
            }),
          ],
        }),
        compareRow("Dashboard Overview", "✓  All JCBs in client", "✓  Own JCB only"),
        compareRow("JCB Machine Filter", "✓  All machines", "–  Auto-filtered to own"),
        compareRow("Live Timer Tracking", "✓  Yes", "✓  Yes"),
        compareRow("Manual Work Entry", "✓  Yes", "✓  Yes"),
        compareRow("Record Worker Payments", "✓  Yes", "Depends on permissions"),
        compareRow("View Work History", "✓  All JCBs + filter", "✓  Own sessions"),
        compareRow("Expenses — View", "✓  All JCBs + filter", "✓  Own expenses"),
        compareRow("Expenses — Add", "✓  Yes", "✓  Yes"),
        compareRow("PDF Report Download", "✓  With JCB filter option", "✓  Auto-labelled with JCB"),
