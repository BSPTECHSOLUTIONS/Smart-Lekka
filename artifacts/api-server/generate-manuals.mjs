...
function buildJcbManual() {
  ...
  sections.push(
    ...
    stepGreen(2, "Enter your Vehicle Number", "Type your machine number (e.g. JCB001, JCB002) in the Vehicle Number / Mobile field."),
    stepGreen(3, "Enter your Password", "Given to you by the admin."),
    stepGreen(4, "Tap Sign In", "You land on your personal Dashboard."),
    spacer(120),
    tipGreen("Your Vehicle Number is your login ID. It is usually in the format JCB001, JCB002, etc. Contact your admin if you need your credentials."),
    spacer(120),
  );
...
function buildCombinedManual() {
  ...
  sections.push(
    ...
    body("The Dashboard shows a full summary across all JCBs — or for one specific Vehicle when filtered."),
    spacer(80),
    infoBox([
    ...
    step(1, "Set Vehicle filter on Dashboard", "All JCBs or a specific machine."),
  ...
  sections.push(
    ...
    stepGreen(2, "Enter your Vehicle Number", "e.g. JCB001, JCB002."),
  ...
  sections.push(
    ...
    new Table({
      ...
      rows: [
        ...
        compareRow("Dashboard Overview", "✓  All JCBs in client", "✓  Own Vehicle only"),
